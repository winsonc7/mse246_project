...
# Pytorch is better
# Make sure you get reasonable performance with the linear regression
# Then revisit the Neural Network
sample_train = pd.read_csv("MS&E 246 Data Updated 3/mathchem_train_152feat copy.csv")
